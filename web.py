...
scheduler.add_job(func=process_inzendingen, trigger="interval", minutes=RUN_INTERVAL)
log("Registered a task for fetching and processing inzendingen to Kalliope every {} minutes".format(RUN_INTERVAL))
